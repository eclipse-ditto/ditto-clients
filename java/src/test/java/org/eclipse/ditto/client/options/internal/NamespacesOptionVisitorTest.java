...
/**
 * Unit test for {@link NamespacesOptionVisitor}.
 */
public final class NamespacesOptionVisitorTest {
    ...
    public void optionValueTypeDiffersFromExpectedType() {
        ...
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> underTest.visit(createOptionMock(OptionName.Consumption.NAMESPACES, value)))
    ...
    public void optionValueIsExpected() {
        ...
        final boolean isFinished =
                underTest.visit(createOptionMock(OptionName.Consumption.NAMESPACES, namespaces));

        assertThat(isFinished).isTrue();
        assertThat(underTest.getValue()).contains(namespaces);
    }
