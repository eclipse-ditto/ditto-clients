...
/**
 * {@link RetrieveFeatureProperty} live command giving access to the command and all of its special accessors.
 * Also the entry  point for creating a {@link RetrieveFeaturePropertyLiveCommandAnswerBuilder} capable
 * of answering incoming commands.
 *
 * @since 2.0.0
 */
