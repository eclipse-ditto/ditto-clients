...
@Immutable
final class RetrieveFeatureDesiredPropertyLiveCommandImpl
        extends AbstractQueryLiveCommand<RetrieveFeatureDesiredPropertyLiveCommand,
        RetrieveFeatureDesiredPropertyLiveCommandAnswerBuilder>
        implements RetrieveFeatureDesiredPropertyLiveCommand {
    ...
    public RetrieveFeatureDesiredPropertyLiveCommand setDittoHeaders(final DittoHeaders dittoHeaders) {
        return of(RetrieveFeatureDesiredProperty.of(getThingEntityId(), getFeatureId(), getDesiredPropertyPointer(),
                dittoHeaders));
    }
