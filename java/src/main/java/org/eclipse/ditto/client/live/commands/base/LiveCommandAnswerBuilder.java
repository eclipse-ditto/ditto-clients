...
/**
 * A mutable builder with a fluent API for an immutable {@link LiveCommandAnswer}.
 * This is the counterpart of {@link LiveCommand} interface.
 *
 * @since 2.0.0
 */
...
public interface LiveCommandAnswerBuilder {
    ...
    interface EventStep<E extends LiveEventFactory> extends LiveCommandAnswerBuilder {
        ...
        /**
         * Configures that no {@link Event} is sent for the incoming {@code Command}.
         * <p> Be careful using this as the sender of the {@code Command} or another party might expect or
         * wait for {@code Event}s. </p>
         *
         * @return the next step for building the answer.
         */
