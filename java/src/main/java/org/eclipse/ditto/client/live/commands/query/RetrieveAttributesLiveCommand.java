...
/**
 * {@link RetrieveAttributes} live command giving access to the command and all of its special accessors.
 * Also the entry point for creating a {@link RetrieveAttributesLiveCommandAnswerBuilder} capable of
