 ...
 * @since 1.0.0
 */
public final class ClientCredentialsAuthenticationProvider implements AuthenticationProvider<WebSocket> {

    private static final Logger LOGGER = LoggerFactory.getLogger(ClientCredentialsAuthenticationProvider.class);
