 ...
 * OptionName.Modify#EXISTS} from the user provided options.
 *
 * @since 1.0.0
 */
@ThreadSafe
final class ExistsOptionVisitor extends AbstractOptionVisitor<Boolean> {

    /**
     * Constructor.
     */
    ExistsOptionVisitor() {
        super(OptionName.Modify.EXISTS);
    }
