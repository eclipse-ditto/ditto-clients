 ...
 * @since 2.0.0
 */
public interface DeleteFeatureLiveCommand
        extends LiveCommand<DeleteFeatureLiveCommand, DeleteFeatureLiveCommandAnswerBuilder>,
        ThingModifyCommand<DeleteFeatureLiveCommand>, WithFeatureId {
}
